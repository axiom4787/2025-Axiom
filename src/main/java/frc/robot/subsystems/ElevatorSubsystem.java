...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    switch (m_state) {
      ...
      case L3:
        ...
        break;
      case SOURCE:
        m_elevatorPID.calculate(m_elevatorMotorL.getEncoder().getPosition(),
            ElevatorConstants.ELEVATOR_SOURCE_POSITION);
        break;
      default:
   ...
   * @return A command that raises the elevator until it reaches the first level setpoint.
   */
   ...
   * @return A command that raises the elevator until it reaches the second level setpoint.
   */
   ...
   * @return A command that raises the elevator until it reaches the third level setpoint.
   */
   ...
   * @return A command that raises the elevator until it reaches the source setpoint.
   */
