...
public class MIntake extends SubsystemBase{
    ...
    private final SparkClosedLoopController m_rot_coral_pid;
    private final SparkClosedLoopController m_arm_algae_1_pid, m_arm_algae_2_pid, m_left_algae_pid, m_right_algae_pid;
