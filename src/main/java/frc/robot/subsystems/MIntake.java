...
public class MIntake extends SubsystemBase{
    ...
    public static Machine mState = Constants.state;

    //set our default speed
    public static final float m_default_speed = cIntake.m_default_speed;

    //Motor Controllers for Coral
    public static final SparkMax m_left_coral = new SparkMax(m_Intake_Motors.motor_coral_1, MotorType.kBrushless), m_right_coral = new SparkMax(m_Intake_Motors.motor_coral_2, MotorType.kBrushless); // Defines Left and Right motors for coral. These are used in coral intake.
    public static final SparkMax m_rot_coral = new SparkMax(m_Intake_Motors.motor_rot_coral, MotorType.kBrushless); // Defines the motor for rotating the coral intake. This is used in coral intake.
    
    //Motor Controllers for Algae
    public static final SparkMax m_arm_algae_1 = new SparkMax(m_Intake_Motors.motor_arm_algae_1, MotorType.kBrushless), m_arm_algae_2 = new SparkMax(m_Intake_Motors.motor_arm_algae_2, MotorType.kBrushless); // Defines the motors for moving the algae arm. These are used in algae intake.
    public static final SparkMax m_left_algae = new SparkMax(m_Intake_Motors.motor_left_algae, MotorType.kBrushless), m_right_algae = new SparkMax(m_Intake_Motors.motor_right_algae, MotorType.kBrushless); // Defines the motors for algae intake. These are used in algae intake.
    ...
    private class Actions {
        ...
        public static void Outtake_Algae(SparkMax m_left_algae, SparkMax m_right_algae, float m_default_speed){
            m_left_algae.set(m_default_speed);
            m_right_algae.set(m_default_speed);
            System.out.println("Outtaking Algae");
        }
        public static void a_Angle_Arm(algae_arm aState, SparkMax m_arm_algae_1, SparkMax m_arm_algae_2) {
            switch(aState){
                case Down:
                    ...
                    System.out.println("Moving Algae Arm Down");
                case Up:
                    ...
                    System.out.println("Moving Algae Arm Up");
        }
    }
