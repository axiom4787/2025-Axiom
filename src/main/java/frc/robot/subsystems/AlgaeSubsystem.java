    ...
    public void periodic() {
        switch (m_state) {
            case OFF:
                ...
                break;
            case INTAKE:
                // TODO: implement logic for extending algae arm to the correct intake position
                // from constants
                ...
                break;
            case OUTTAKE:
                // TODO: retract algae arm to resting (outtake) position from constants
                // only trigger outtake wheels once arm is in correct position
