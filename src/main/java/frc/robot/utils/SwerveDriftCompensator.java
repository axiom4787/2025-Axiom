...
public class SwerveDriftCompensator {
    ...
    /**
     * Apply drift compensation to chassis speeds based on expected vs actual motion.
     * 
     * @param requestedSpeeds The speeds requested by the driver or autonomous system
