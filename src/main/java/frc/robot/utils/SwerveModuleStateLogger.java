...
/**
 * Utility for logging swerve module states to AdvantageScope with proper optimization math.
 */
public class SwerveModuleStateLogger {
    ...
    /**
     * Optimizes a swerve module state to minimize rotation while maintaining desired direction of travel.
     * This is the correct swerve math that minimizes module rotation by flipping direction when appropriate.
     * 
