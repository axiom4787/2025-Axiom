...
public class RobotContainer {
	...
	private void configureBindings() {
		...
		Trigger gyroReset = m_controller.back().onTrue(new
		InstantCommand(m_swerveSubsystem::zeroGyroWithAlliance));
		...
		m_controller.start().onTrue(new InstantCommand(() -> {
			...
			m_swerveSubsystem.toggleFieldRelative();
		}));
	}
	...
	public Command getTeleopCommand() {
		return m_swerveSubsystem.driveCommand(
	...
	{
		m_swerveSubsystem.findStartingVisionPose();
	}
}
