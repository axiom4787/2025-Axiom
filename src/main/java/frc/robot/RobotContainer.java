...
public class RobotContainer {
    ...
    private final LEDSubsystem m_LedSubsystem = new LEDSubsystem(LEDConstants.LED_PORT);
    ...
    private void configureBindings() {
        ...
        // Reset the pose and gyro based on Limelight data when the options button is
        // pressed
    ...
    public Command getAutonomousCommand() {
        ...
        Command auto3 = new SequentialCommandGroup(
                new WaitCommand(5.0),
                new RunCommand(
                        () -> m_driveSubsystem.driveRobotRelative(new ChassisSpeeds(0.0, mediumSideSpeed, 0.0)),
